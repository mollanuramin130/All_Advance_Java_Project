...
<!-- //redirect EmployeeSarvlet
//JSP page for Employee Add,update, delete and view operations
//registration form 

-->
<!-- 
adding 4 buttons for add, update, delete and view operations in index.jsp
 -->
